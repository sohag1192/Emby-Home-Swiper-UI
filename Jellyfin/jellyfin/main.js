/*
 * Script Name: Jellyfin/Emby Home Banner with Auto-Scroll
 * Description: Displays the latest 20 Movies and TV Shows mixed together.
 * Includes Auto-scroll (20s), Play Button fix, and Visitor Counter.
 * Author: Edited for Sohag
 */
...
class HomeBanner {
    ...
    static start() {
        ...
        this.itemQuery = {
            ...
            IncludeItemTypes: "Movie,Series", // Movies and Series
            SortBy: "DateCreated, ProductionYear", // Sort by Newest Created
            Recursive: true,
            ImageTypeLimit: 2,
    ...
    static async initBanner() {
        ...
        data.Items.forEach(async (item) => {
            ...
            // Limits description to 200 characters to keep it clean
            ...
            // Using cleanDescription instead of detail.Overview
            itemHtml += `
					<div>
    ...
    static initEvent() {
        ...
        $(document).on('click', '.banner-item-play', function(e) {
            e.preventDefault();
            e.stopPropagation(); // Prevents opening info page
